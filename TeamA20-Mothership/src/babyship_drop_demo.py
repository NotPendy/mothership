...
if vehicle.version.vehicle_type == mavutil.mavlink.MAV_TYPE_QUADROTOR:
    ...
    print("Waiting for mode to switch to THROW")
    while vehicle.mode.name != "THROW":
        time.sleep(1)

    print("waiting for mother to actually throw. Arm before swapping to throw mode on mavproxy")
